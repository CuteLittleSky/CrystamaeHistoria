...
public enum StoryRank {
    ...
    EMERITUS_PROFESSOR(95, ThemeType.RANK_STORY_EMERITUS_PROFESSOR),
    ADJUNCT_PROFESSOR(87, ThemeType.RANK_STORY_ADJUNCT_PROFESSOR),
    PROFESSOR(68, ThemeType.RANK_STORY_PROFESSOR),
    LECTURER(48, ThemeType.RANK_STORY_LECTURER),
